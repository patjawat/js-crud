      ...
      <div className="card">
        ...
        <div className="card-body">
          ...
          <div className="position-relative mb-4"><div className="chartjs-size-monitor"><div className="chartjs-size-monitor-expand"><div className /></div><div className="chartjs-size-monitor-shrink"><div className /></div></div>
            <canvas id="visitors-chart" height={400} width={1064} className="chartjs-render-monitor" style={{display: 'block', height: 200, width: 532}} />
          </div>
    ...
    <div className="col-lg-6">
      <div className="card">
        ...
        <div className="card-body">
          ...
          {/* /.d-flex */}
          <div className="position-relative mb-4"><div className="chartjs-size-monitor"><div className="chartjs-size-monitor-expand"><div className /></div><div className="chartjs-size-monitor-shrink"><div className /></div></div>
            <canvas id="sales-chart" height={400} style={{display: 'block', height: 200, width: 532}} width={1064} className="chartjs-render-monitor" />
          </div>
          <div className="d-flex flex-row justify-content-end">
            <span className="mr-2">
